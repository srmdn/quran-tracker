...
export const MurojaahPage: FC<{
                ...
                <div class="border-t border-border-light pt-4">
                  ...
                  <div class="space-y-3">
                    <div>
                      ...
                      <select name="start_surah" id="mur-start-surah-sel"
                    ...
                    <div>
                      ...
                      <input type="number" name="start_ayah" id="mur-start-ayah-inp" min="1" step="1" placeholder="e.g. 1"
                        class="w-full rounded-lg border-slate-200 bg-slate-50 text-sm" />
                      <p id="mur-start-ayah-hint" class="text-xs text-text-secondary mt-1"></p>
                    </div>
                  </div>
                </div>
                <div class="border-t border-border-light pt-4">
  ...
  var startAyahInp=document.getElementById('mur-start-ayah-inp');
  var startHint=document.getElementById('mur-start-ayah-hint');
